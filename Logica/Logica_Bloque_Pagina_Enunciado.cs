...
namespace Logica
{
    public class Logica_Bloque_Pagina_Enunciado
    {
        ...
        public int Logica_Comprar_Mi_Ejercicio_Personalizado_Desde_Enunciado(int ID_Usuario, string IP_Address, int ID_Empresa, bool Adjunto, string Archivo, bool Ejercicio_Personalizado)
        {
            return BPE.Metodo_Comprar_Mi_Ejercicio_Personalizado_Desde_Enunciado(ID_Usuario, IP_Address, ID_Empresa, Adjunto, Archivo,Ejercicio_Personalizado);
        }

        public int Logica_Comprar_Mi_Explicacion_Personalizada_Desde_Enunciado(int ID_Usuario, string IP_Address, int ID_Empresa, bool Adjunto, string Archivo, bool Explicacion_Personalizada)
        {
            return BPE.Metodo_Comprar_Mi_Explicacion_Personalizada_Desde_Enunciado(ID_Usuario, IP_Address, ID_Empresa, Adjunto, Archivo, Explicacion_Personalizada);
        }
