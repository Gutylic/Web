<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagina_Fichas.aspx.cs" Inherits="Fenicia_Web.Pagina_Fichas" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="col-xs-12" style="text-align:center">
                                <asp:Button ID="Buscar_Por_Enunciado" runat="server" ToolTip="busque ejercicios similares por enunciado" CssClass="btn btn-primary" Text="Buscar por Enunciado" OnClick="Buscar_Por_Enunciado_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpdatePanel_DataList" runat="server">
                                <ContentTemplate>
                                    <asp:DataList ID="Resultado_DataList_Ficha" CssClass="datalist_resultado" runat="server" OnItemCommand="Identificador">
                                        <ItemTemplate>
