    ...
    <form id="form1" runat="server">
       ...
       <%-- <script type="text/javascript" lang="javascript">
            function RegistrarTriggers(control) {
                ...
                Sys.WebForms.PageRequestManager._initialize('ScriptManager1', 'form1', ['tUpdatePanel_DataList', 'UpdatePanel_DataList', 'tUpdatePanel_Botones_Externos_Datalist', 'UpdatePanel_Botones_Externos_Datalist'], [], [control], 90, '');
                alert(control);
            }
        ...
        <header id="main-header">
            <%-- estilos del encabezado en encabezado --%>
            <div class="container">
                <div class="row">
